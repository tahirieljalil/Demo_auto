...
//WebUI.click(findTestObject('Gestion des avocats_Creation_Recherche_dans_la_selection/input_Slectionner_search-input'))
WebUI.setText(findTestObject('Gestion des avocats_Creation_Recherche_dans_la_selection/input_Slectionner_search-input'), 
    'rabat')

WebUI.click(findTestObject('Gestion des avocats_Creation_Recherche_dans_la_selection/mark_RABAT'))

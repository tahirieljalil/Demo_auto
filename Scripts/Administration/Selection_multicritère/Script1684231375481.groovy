...
WebUI.click(findTestObject('Multicritre - Gestion des experts conseils/li_CAT Assurance et Rassurance'))

WebUI.click(findTestObject('Multicritre - Gestion des experts conseils (1)/li_Wafa Assurance'))

...
WebUI.click(findTestObject('Object Repository/annulation et affectatopn/Page_Mission expertise - Suivi des missions/i_En Attente_fas fa-user-slash'))

WebUI.verifyElementVisible(findTestObject('Object Repository/annulation et affectatopn/Page_Mission expertise - Suivi des missions/td_Annule Affectation'), 

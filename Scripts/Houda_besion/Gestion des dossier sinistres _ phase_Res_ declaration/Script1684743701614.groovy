...
/*WebUI.setText(findTestObject('Object Repository/declaration_B_H/Page_Gestion des dossiers sinistres - Ouver_cd5ce2/input_N CNIERC_GarantieVehicule.NCNIRC'), 
    ((Doc + R2) + R3) + R1)*/
WebUI.setText(findTestObject('AA_Page_Gestion des dossiers sinistres_aprs_continue (3)/input_Date dchance_GarantieResidentiel.DateEcheance'), 
    randomDateString)

WebUI.setText(findTestObject('AA_Page_Gestion des dossiers sinistres_aprs_continue (1)/input_Ville_GarantieResidentiel.Ville'), 
    ville)

WebUI.setText(findTestObject('AA_Page_Gestion des dossiers sinistres_aprs_continue/input_Adresse_GarantieResidentiel.Adresse'), 
    adress)

String MinusDayStr = randomDateString.minus(1)

WebUI.setText(findTestObject('AA_Page_Gestion des dossiers sinistres_aprs_continue (2)/input_Date deffet_GarantieResidentiel.DateEffet'), 
    MinusDayStr.minus(1))

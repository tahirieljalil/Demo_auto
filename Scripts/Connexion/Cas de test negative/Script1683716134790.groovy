...
WebUI.click(findTestObject('Object Repository/Cas de test negative/Page_CAT - Authentification/button_Connexion'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Cas de test negative/Page_CAT - Authentification/li_Votre login ou mot de passe est incorrect'), 
    3)
